...
# 将图像粘贴在另一个图像上
# # 载入另一张图像
# watermark = Image.open(os.path.join(data_path, 'logo.jpg'))
# # 改成合适的大小
...
# # 进行粘贴
# image_copy.paste(watermark, position, watermark.convert('RGBA'))
...
# img_draw.rectangle((70, 50, 270, 200), outline=None, fill='gray')
# # 通过画线来画一个四方框的框线并控制粗细
...
# img_draw.ellipse((270-r, 200-r, 270+r, 200+r), fill='orange')1
# # 画一个多边形
...
plt.imshow(greyscale_image, cmap='pink')
plt.show()
